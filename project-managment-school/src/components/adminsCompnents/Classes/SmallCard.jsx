...
function SmallCard({ text, notNavigate, handleDelete, id }) {
  return (
    <>
      {notNavigate ? (
        <div className="w-fit  m-2 cursor-pointer hover:border-none hover:bg-slate-300 h-16 px-8 py-4 rounded-2xl border border-black justify-center items-center gap-2 inline-flex">
