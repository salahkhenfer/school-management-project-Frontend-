...
function Languages() {
  ...
  return (
    <div className={`max-w-[1000px] duration-200 relative w-full mx-auto `}>
      <div className="w-full h-28 py-10 mx-auto text-center text-gray-800 text-4xl font-semibold font-['Cairo'] leading-10">
        اللغات الموجودة
      </div>
